...
| 3      | Decision Tree| [Here]() | Implémentation et usage des decisions trees aux travers du problème du Titanic | ❌ |
| 4      | Genetic Algorithm, an universal algorithm | [Here](Track-IA/03-GeneticAlgorithm.ipynb) | Implémentation d'un génétic algorithm dans le but de trouvé la solution au travelsman problem | ✅ |
| 5      | Genetic Programming | [Here]() | Implémentation d'un génétic algorithm dans le but de résoudre des problèmes complexes via openai gym | ❌ |
